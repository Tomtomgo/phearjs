(function() {
  ...
  run_server = function() {
    ...
    service = server.listen(config.port, function(request, response) {
      var err, escaped_fetch_url, parse_delay, parsed_fetch_url, request_headers, request_url, this_inst, _ref, _ref1;
      ...
      if ((((_ref = request_url.query) != null ? _ref.fetch_url : void 0) == null) || !request_url.query.fetch_url) {
      ...
      parse_delay = ((_ref1 = request_url.query) != null ? _ref1.parse_delay : void 0) || config.parse_delay;
      request_headers = {};
